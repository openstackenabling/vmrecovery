...
class RecoverManager(manager.Manager):
    ...
    def monitor_host(self, context):
        '''
        After starting recover service, running this method periodic to monitor failed node and sent message to Queue
        :param context:
        :return:
        '''
        self.driver.monitor_host(context)


    def recover_vm(self ,context, port_id, port_mac, vm_uuid, vm_name):
        """
        Recvoer vm net by quantum service ,and vm by libvirt
        :param context:
        :param port_id:
        :param port_mac:
        :param vm_uuid:
